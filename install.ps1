<#
	.SYNOPSIS
		Installs the VMDeploy.Management Module from github
		
	.DESCRIPTION
		This script installs the VMDeploy.Management Module from github.
