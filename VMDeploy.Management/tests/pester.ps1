...
Remove-Module VMDeploy.Management -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\VMDeploy.Management.psd1"
Import-Module "$PSScriptRoot\..\VMDeploy.Management.psm1" -Force
