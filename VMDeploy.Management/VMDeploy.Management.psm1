...
if ($VMDeployManagement_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName VMDeploy.Management.Import.IndividualFiles -Fallback $false
if ($VMDeployManagement_importIndividualFiles) { $importIndividualFiles = $true }
